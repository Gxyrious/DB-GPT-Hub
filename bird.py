...
data_info = [
        {
            ...
            "train_output": "bird_train.json",
            "dev_output": "bird_dev.json",
        }
]
...
train_args = {
            ...
            "lora_rank": 64,
            "lora_alpha": 32,
            "output_dir": "dbgpt_hub/output/adapter/bird/CodeLlama-7b-sql-lora",
...
predict_args = {
            ...
            "template": "llama2",
            "finetuning_type": "lora",
            "checkpoint_dir": "dbgpt_hub/output/adapter/bird/CodeLlama-7b-sql-lora",
            # "predict_file_path": "dbgpt_hub/data/eval_data/dev_sql.json",
            # "predict_out_dir": "dbgpt_hub/output/",
            "predicted_out_filename": "pred_sql_bird.sql",
            # "data_args": ''
}
...
evaluate_args =  {
            ...
            "input": "pred_sql_bird.sql",
            "gold": "./dbgpt_hub/data/bird/dev_gold.sql",
            # "gold_natsql": "./dbgpt_hub/data/eval_data/gold_natsql2sql.txt",
            "db": "./dbgpt_hub/data/bird/database",
            "table": "./dbgpt_hub/data/bird/tables.json",
