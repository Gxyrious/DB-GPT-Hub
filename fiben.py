...
data_info = [
        {
            ...
            "train_output": "fiben_train.json",
            "dev_output": "fiben_dev.json",
        }
]
...
train_args = {
            ...
            "lora_rank": 64,
            "lora_alpha": 32,
            "output_dir": "dbgpt_hub/output/adapter/fiben_enhanced2/CodeLlama-7b-sql-lora",
...
predict_args = {
            ...
            "template": "llama2",
            "finetuning_type": "lora",
            "checkpoint_dir": "dbgpt_hub/output/adapter/fiben_enhanced2/CodeLlama-7b-sql-lora",
            # "predict_file_path": "dbgpt_hub/data/eval_data/dev_sql.json",
            # "predict_out_dir": "dbgpt_hub/output/",
            "predicted_out_filename": "pred_sql_fiben_enhanced2.sql",
            # "data_args": ''
}
...
evaluate_args =  {
            ...
            "input": "pred_sql_fiben_enhanced2.sql",
            "gold": "./dbgpt_hub/data/fiben/dev_gold.sql",
            # "gold_natsql": "./dbgpt_hub/data/eval_data/gold_natsql2sql.txt",
            "db": "./dbgpt_hub/data/fiben/database",
            "table": "./dbgpt_hub/data/fiben/tables.json",
